	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Article->save($this->request->data)) {
				$this->Session->setFlash(__('El artículo ha sido guardado satisfactoriamente.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('El artículo no pudo ser guardado; por favor intente nuevamente.'));
			}
		}
