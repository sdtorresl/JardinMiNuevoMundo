	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Category->save($this->request->data)) {
				$this->Session->setFlash(__('La categoría ha sido guardada satisfactoriamente.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('La categoría no ha sido guardada satisfactoriamente; por favor intente nuevamente.'));
			}
		}
